...
//remove bq24152 and bq27510 Macros
...
enum DSM_BMS_ERR
{
	...
	DSM_BMS_NORMAL_SOC_ERROR_NO,
	DSM_BMS_BQ_UPDATE_FIRMWARE_FAIL_NO,
};
...
enum DSM_CHARGER_ERR
{
	...
	DSM_CHARGER_ADC_ABNORMAL_ERROR_NO,
	DSM_CHARGER_BQ_BOOST_FAULT_ERROR_NO,
	DSM_CHARGER_BQ_NORMAL_FAULT_ERROR_NO,
	DSM_CHARGER_BQ_I2C_ERROR_NO,
};
